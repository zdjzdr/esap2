 ...
 */
var c1 = ['cDate', 'rem', 'id'],
	c2 = ['mid', 'lot', 'qty', 'lcid', 'id','mUn','cDate'],
	m1 = 'wmb',
	m2 = '' + m1 + '_d',
	h1 = '结算表',
	t1 = 't6.1';
var g1h1 = {header: '日期', dataIndex: 'cDate', editor: 'textfield', xtype: 'datecolumn', format:'Y-m-d'},
	g1h2 = {header: '备注', dataIndex: 'rem', editor: 'textfield'};
var g2h1 = {header: '仓库', dataIndex: 'lcid', editor: 'textfield'},
	g2h2 = {header: '编号', dataIndex: 'mid', editor: 'textfield'},
	g2h3 = {header: '数量', dataIndex: 'qty', editor: 'numberfield'},
	g2h4 = {header: '批号', dataIndex: 'lot', editor: 'textfield'},
	g2h5 = {header: '单位', dataIndex: 'mUn', editor: 'textfield'},
	g2h6= {header: '结算日', dataIndex: 'cDate', editor: 'textfield'};
/**
 * 模板主体
 * 主从表模板：主表-明细 支持增删改
 */
	...
	tbar:[{
		...
		text: '修改', iconCls: 'icon-yes', handler: function () {		
			...
			var fm = Ext.create('ex.Form', {
				...
				items: [{
						name: 'cDate', fieldLabel:'日期', format: 'Y-m-d', anchor: '100%'
					},{
						name: 'rem', fieldLabel: '备注', anchor: '100%'
					},{
					...
					items: [,{
						xtype: 'xgrid2',
						store: s3,
						columns: [g2h1,g2h2,g2h3,g2h4,g2h5,g2h6]
					}]
				}],
